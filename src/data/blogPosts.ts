...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: ["Headache causes are generally grouped into three categories:"],
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: ["These factors may increase your risk of developing an anxiety disorder:"],
        list: [
      ...
      },
      {
        ...
        paragraphs: ["Anxiety disorders can lead to or worsen other conditions, including:"],
        list: [
      ...
      {
        heading: "Prevention",
        paragraphs: ["There is no way to predict for certain what will cause someone to develop an anxiety disorder, but these steps can help reduce the impact of symptoms:"],
        list: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "Causes",
        paragraphs: ["It is not known exactly what causes depression. As with many mental disorders, a variety of factors may be involved:"],
        list: [
      ...
      {
        heading: "Risk Factors",
        paragraphs: ["Depression often begins in the teens, 20s, or 30s, but can happen at any age. Factors that may increase risk include:"],
        list: [
      ...
      {
        heading: "Complications",
        paragraphs: ["Depression often gets worse if untreated, resulting in emotional, behavioral, and health problems that affect every area of life, including:"],
        list: [
      ...
      {
        heading: "Prevention",
        paragraphs: ["There is no sure way to prevent depression, but these strategies may help:"],
        list: [
  ...
  {
    slug: "sleep-disorders-insomnia-hypersomnia",
    title: "Understanding Sleep Disorders: Insomnia and Hypersomnia",
    excerpt:
      "Sleep plays a critical role in physical and mental health, yet many people struggle with sleep disorders like insomnia and hypersomnia. Here's what causes them, how they present, and how they're treated.",
    date: "August 4, 2026",
    ...
    content: [
      {
        paragraphs: [
          "Sleep is a state of reduced mental and physical activity in which consciousness is altered and certain sensory activity is inhibited. Researchers have found that sleeping 6–7 hours each night correlates with longevity and cardiac health in humans.",
          "Humans may suffer from various sleep disorders, including dyssomnias such as insomnia (lack of sleep), hypersomnia (oversleeping), narcolepsy, and sleep apnea; and parasomnias such as sleepwalking, rapid eye movement sleep behavior disorder, bruxism, and circadian rhythm sleep disorders.",
          "Sleep difficulties are furthermore associated with psychiatric disorders such as depression, alcoholism, bipolar disorder, and anxiety. Up to 90% of adults with depression are found to have sleep difficulties, with dysregulation detected by EEG including disturbances in sleep continuity, among many other changes.",
        ],
      },
      {
        heading: "Insomnia",
        paragraphs: [
          "Insomnia is a common sleep disorder that makes it hard to fall asleep or causes you to wake up too early without being able to go back to sleep.",
        ],
      },
      {
        heading: "Symptoms of Insomnia",
        paragraphs: [],
        list: [
      ...
      {
        heading: "What Causes Insomnia?",
        paragraphs: [],
        list: [
          "Family history (genetics): sleep traits and conditions seem to run in families",
          "Medical conditions: about half of people with chronic illnesses tend to develop insomnia",
          "Life circumstances such as stress",
          "Hormonal changes: pregnancy and menopause can affect sleep, among other factors",
        ],
      },
      {
        heading: "How Is Insomnia Treated?",
        paragraphs: [
          "The main approaches for insomnia include cognitive behavioral therapy and medications (sleeping pills).",
        ],
      },
      {
        heading: "Cognitive Behavioral Therapy for Insomnia",
        paragraphs: [
          "The purpose of CBT is to identify behaviors, thoughts, beliefs, and emotions that may be keeping insomnia going. A healthcare professional then helps develop strategies to address these issues.",
        ],
        list: [
          "Sleep restriction therapy: addresses the mismatch between your sleep ability (how much you actually sleep) and your sleep opportunity (how much time you spend in bed)",
          "Stimulus control therapy: encourages activities associated with sleep (like lying down when sleepy) while avoiding ones that aren't (like watching TV), along with getting up at the same time every day and avoiding naps",
          "Sleep hygiene: your therapist walks you through improving your sleep environment and habits — for example, avoiding caffeine and alcohol before bedtime and creating a comfortable sleeping environment",
          "Medications: many medications can help you fall or stay asleep, though effectiveness varies between individuals for reasons that are still not fully understood — examples include benzodiazepines, \"Z-drugs,\" dual orexin receptor antagonists, and melatonin",
        ],
      },
      {
        heading: "When Should You See a Doctor?",
        paragraphs: [
          "See your doctor if treatment is not helping with your insomnia symptoms. Reach out to them if your symptoms get worse or if you experience medication side effects.",
        ],
      },
      {
        heading: "Hypersomnia",
        paragraphs: [
          "Hypersomnia is any condition that makes you feel extremely sleepy during the day, even though you get a healthy amount of sleep or more than enough. Hypersomnia can affect your ability to go to school or work.",
        ],
      },
      {
        heading: "Symptoms of Hypersomnia",
        paragraphs: [],
        list: [
          "Anxiety and irritability",
          "Constant episodes of extreme sleepiness during the day",
          "Decreased energy",
          "Difficulty waking up in the morning",
          "Feeling confused or angry when waking up",
          "Headaches",
          "Loss of appetite",
          "Sleeping longer than usual (11 hours) but still waking up sleepy",
        ],
      },
      {
        heading: "What Causes Hypersomnia?",
        paragraphs: [],
        list: [
          "Genetic variations",
          "Issues with neurotransmitters in the brain",
          "An overactive immune system after an infection",
        ],
      },
      {
        heading: "Types of Hypersomnia",
        paragraphs: [],
        list: [
          "Idiopathic hypersomnia: hypersomnia that happens without any identified cause — this is the more common type",
          "Kleine-Levin syndrome: causes unusually long sleep, often 16 to 20 hours a day during an episode; very rare",
          "Narcolepsy: occurs when the brain cannot properly control the ability to sleep or stay awake",
          "Secondary hypersomnia: happens when something else causes extreme sleepiness, such as alcohol and drugs, health conditions affecting the muscles, brain, or central nervous system, mental disorders, head injuries, not getting enough sleep, or side effects from medications",
        ],
      },
      {
        heading: "How Is Hypersomnia Diagnosed?",
        paragraphs: ["Most sleep disorders are diagnosed by sleep specialists."],
      },
      {
        ...
        list: [
          ...
          "Therapy if the hypersomnia is caused by anxiety, stress, or other mental health issues",
          "Treatment targeted at the specific underlying cause in cases of secondary hypersomnia",
        ],
      },
    ],
  },
...
EOFcat > src/data/blogPosts.ts << 'EOF'
import headacheHeroImage from "../assets/Head.jpg";
import anxietyImage from "../assets/Anxiety.jpg";
import DepressionImage from "../assets/Depression.jpg";
import epilepsyandseizureImage from "../assets/epilepsy and seizure.jpg";
