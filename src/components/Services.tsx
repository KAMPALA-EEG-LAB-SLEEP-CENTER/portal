...
import servicesDepressionImage from "../assets/services-depression.jpg";
    ...
    <section id="services" className="bg-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-xs font-semibold text-[#0D9488] tracking-wide">
            EXPERT DIAGNOSTICS
          </span>
          <h2 className="text-3xl sm:text-4xl font-bold text-[#0B1220] mt-3 mb-4">
            Specialized EEG Services
          </h2>
          <p className="text-gray-500 text-base">
            We offer advanced brain testing for both adults and children facing
            neurological and mental health challenges.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Support mental health diagnosis through real-time brain
                  monitoring. Detect biomarkers associated with
                  treatment-resistant depression.
                </p>
              </div>
            </div>
            <img
              src={servicesDepressionImage}
              alt="Doctors reviewing patient EEG results"
          ...
          <div className="bg-[#0B1220] rounded-2xl p-8 flex flex-col justify-between text-white">
            <div>
              ...
              <p className="text-sm text-gray-300">
                Detect abnormal brain waves and seizure patterns with high
                precision.
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8">
            ...
            <p className="text-sm text-gray-500">
              Diagnose for insomnia, apnea, and restlessness. Evaluate sleep
              cycles for root causes of fatigue.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8">
            ...
            <p className="text-sm text-gray-500">
              Track post-stroke recovery and early-stage cognitive changes
              through neuro-activity mapping.
            </p>
          </div>
          ...
          <div className="bg-[#0D9488] rounded-2xl p-8 text-white">
            ...
            <p className="text-sm text-teal-50">
              Gentle, child-friendly testing for developmental delays or
